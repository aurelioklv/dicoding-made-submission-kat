...
# Preserve classes in the data package
-keep class com.aurelioklv.kat.core.data.** { *; }

# Preserve classes in the domain package
-keep class com.aurelioklv.kat.core.domain.** { *; }

# Preserve classes in the local preferences package
-keep class com.aurelioklv.kat.core.data.local.preferences.** { *; }

# Preserve classes used with reflection (e.g., for dependency injection frameworks)
